...
* Assets/Plugins/Arbor/CHANGELOG-ja
  Update log
* Assets/Plugins/Arbor/Docs/ArborManual_en.zip
  Arbor instruction manual.
  When browsing, please unzip it to any folder.
* Assets/Plugins/Arbor/Docs/ArborReference_en.zip
  A reference for the built-in scripts for components and nodes that can be used with Arbor.
  When browsing, please unzip it to any folder.
* Assets/Plugins/Arbor/Docs/ScriptReference_en.zip
  Script Referencve
  Please refer when calling the API of Arbor from the script.
  When browsing, please unzip it to any folder.
...
* Manual : https://caitsithware.com/assets/arbor/docs/en/index.html
  Manual of detailed usage.
  The same as the included ArborManual_en.zip.
* Arbor Reference : https://arbor-docs.caitsithware.com/en/
  A reference for the built-in scripts for components and nodes that can be used with Arbor.
  The same as the included ArborReference_en.zip.
* Script Reference : https://caitsithware.com/assets/arbor/scriptreference/ja/annotated.html
  References such as classes that can be used in Arbor.
  The same as the included ScriptReference_en.zip.

### Download online documentation

https://arbor.caitsithware.com/en/download_reference/

You can download various online documents from here.
