	...
	public sealed partial class Parameter
	{
		...
		public bool SetEnum(System.Enum value)
		{
			if (type == Type.Enum && value != null)
			{
				...
				if (EnumFieldUtility.IsEnum(enumType))
				{
					...
					Internal_SetInt(System.Convert.ToInt32(value));
					return true;
				}
			}
		...
		public bool TryGetEnum(out System.Enum value)
		{
			if (isEnum)
			{
				...
				value = (System.Enum)System.Enum.ToObject(enumType, Internal_GetInt());
				return true;
			}
		...
		/// <returns>Return true if the value could be set.</returns>
#endif
		public bool SetEnum<TEnum>(TEnum value) where TEnum : struct
		{
		...
		/// <returns>Return true if the value can be obtained.</returns>
#endif
		public bool TryGetEnum<TEnum>(out TEnum value) where TEnum : struct
		{
			System.Type enumType = typeof(TEnum);

			if (type == Type.Enum && EnumFieldUtility.IsEnum(enumType))
			{
				value = (TEnum)System.Enum.ToObject(enumType, Internal_GetInt());
				return true;
			}
		...
		/// <returns>The value of the parameter. If there is no parameter, it returns defaultValue.</returns>
#endif
		public TEnum GetEnum<TEnum>(TEnum defaultValue) where TEnum : struct
		{
			TEnum value;
