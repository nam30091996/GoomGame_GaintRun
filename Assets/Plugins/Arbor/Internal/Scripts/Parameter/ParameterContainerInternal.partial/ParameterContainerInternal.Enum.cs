...
namespace Arbor
{
	public partial class ParameterContainerInternal : ParameterContainerBase, ISerializationCallbackReceiver
	{
		...
		private bool SetEnum<TEnum>(Parameter parameter, TEnum value) where TEnum : struct
		{
		...
		/// <returns>The true when there parameters of the specified name.</returns>
#endif
		public bool SetEnum<TEnum>(string name, TEnum value) where TEnum : struct
		{
			Parameter parameter = GetParam(name);
			return SetEnum(parameter, value);
		}
		...
		/// <returns>The true when there parameters of the specified name.</returns>
#endif
		public bool SetEnum<TEnum>(int id, TEnum value) where TEnum : struct
		{
			Parameter parameter = GetParam(id);
			return SetEnum(parameter, value);
		}

		private bool TryGetEnum<TEnum>(Parameter parameter, out TEnum value) where TEnum : struct
		{
			if (parameter != null)
			{
		...
		/// <returns>The true when there parameters of the specified name.</returns>
#endif
		public bool TryGetEnum<TEnum>(string name, out TEnum value) where TEnum : struct
		{
			Parameter parameter = GetParam(name);
			return TryGetEnum(parameter, out value);
		}
		...
		/// <returns>The true when there parameters of the specified name.</returns>
#endif
		public bool TryGetEnum<TEnum>(int id, out TEnum value) where TEnum : struct
		{
			Parameter parameter = GetParam(id);
			return TryGetEnum(parameter, out value);
		}
		...
		/// <returns>The value of the parameter. If there is no parameter, it returns defaultValue.</returns>
#endif
		public TEnum GetEnum<TEnum>(int id, TEnum defaultValue) where TEnum : struct
		{
			TEnum value;
			if (TryGetEnum(id, out value))
			{
