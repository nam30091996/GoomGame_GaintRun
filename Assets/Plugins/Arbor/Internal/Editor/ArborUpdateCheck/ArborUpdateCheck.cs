...
namespace ArborEditor.UpdateCheck
{
	...
	internal sealed class ArborUpdateCheck : Arbor.ScriptableSingleton<ArborUpdateCheck>, IUpdateCallback
	{
...
#if ARBOR_DLL
		static readonly System.Reflection.MethodInfo s_SendWebRequestMethodInfo;
		...
		static ArborUpdateCheck()
		{
			...
			s_SendWebRequestMethodInfo = unityWebRequestType.GetMethod("SendWebRequest",System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public);
			if (s_SendWebRequestMethodInfo == null)
			{
				s_SendWebRequestMethodInfo = unityWebRequestType.GetMethod("Send", System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public);
			}
		...
		public void CheckStart(System.Action onDone, bool force = false)
		{
			...
			if (s_SendWebRequestMethodInfo != null)
			{
				s_SendWebRequestMethodInfo.Invoke(_Request, null);
			}
