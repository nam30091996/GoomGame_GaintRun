...
namespace ArborEditor
{
	...
	public sealed class Icons
	{
		...
		public static Texture2D GetStateIcon(State state)
		{
			...
			{
				return isCurrentState ? currentStartStateIcon : startStateIcon;
			}
			...
			return isCurrentState ? currentNormalStateIcon : normalStateIcon;
		}
		...
		public static Texture GetTypeIcon(Type type)
		{
			...
			if (typeof(UnityObject).IsAssignableFrom(type))
			{
				...
				if (s_DefaultAssetIcon != null)
				{
					return s_DefaultAssetIcon;
				}
			}
