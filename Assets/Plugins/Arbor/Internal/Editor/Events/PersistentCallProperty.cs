...
namespace ArborEditor.Events
{
	...
	internal sealed class PersistentCallProperty
	{
		...
		IEnumerable<SerializedProperty> GetArgumentParameters()
		{
			yield return parameterListProperty.intParametersProperty;
			yield return parameterListProperty.floatParametersProperty;
			yield return parameterListProperty.boolParametersProperty;
			yield return parameterListProperty.stringParametersProperty;
			yield return parameterListProperty.vector2ParametersProperty;
			yield return parameterListProperty.vector3ParametersProperty;
			yield return parameterListProperty.quaternionParametersProperty;
			yield return parameterListProperty.rectParametersProperty;
			yield return parameterListProperty.boundsParametersProperty;
			yield return parameterListProperty.colorParametersProperty;
			yield return parameterListProperty.gameObjectParametersProperty;
			yield return parameterListProperty.componentParametersProperty;
			yield return parameterListProperty.enumParametersProperty;
			yield return parameterListProperty.inputSlotParametersProperty;
			yield return outputSlotsProperty;
		}
