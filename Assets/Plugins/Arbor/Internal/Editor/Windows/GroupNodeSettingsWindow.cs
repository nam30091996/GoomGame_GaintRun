...
namespace ArborEditor
{
	...
	internal sealed class GroupNodeSettingsWindow : PopupWindowContent
	{
		...
		void DoGUI()
		{
			...
			Color color = _LayoutArea.ColorField(EditorGUITools.GetTextContent("Color"), _GroupNode.color, true, false, false);
			GroupNode.AutoAlignment autoAlignment = (GroupNode.AutoAlignment)_LayoutArea.EnumPopup(EditorGUITools.GetTextContent("Auto Alignment"), _GroupNode.autoAlignment);
