...
namespace Arbor.StateMachine.StateBehaviours
{
	...
	public abstract class ListBehaviourBase : StateBehaviour
	{
		...
		void CallOnExecute()
		{
			...
			object returnArray = OnExecute(elementType, array, _OutputType);
			if (returnArray != null)
			{
		...
		protected abstract object OnExecute(System.Type elementType, object array, ListInstanceType outputType);
	}
}