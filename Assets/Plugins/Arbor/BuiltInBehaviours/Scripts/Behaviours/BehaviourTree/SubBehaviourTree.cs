...
namespace Arbor.StateMachine.StateBehaviours
{
	...
	/// <param name="Restart On Finish" order="10">終了時に再開するフラグ。</param>
	/// <param name="Execution Settings" order="11">実行に関する設定。</param>
#else
	/// <summary>
	/// Play a child hierarchy Behavior Tree
	/// </summary>
	/// <param name="OpenButton" order="-1">Open Behavior Tree of child hierarchy</param>
	/// <param name="Restart On Finish" order="10">Flag to restart at finish.</param>
	/// <param name="Execution Settings" order="11">Settings related to execution.</param>
#endif
	[AddComponentMenu("")]
	...
	[ExcludeFromPreset]
#endif
	public sealed class SubBehaviourTree : StateBehaviour, INodeGraphContainer
	{
		/// <summary>
		/// Behaviour Tree
		/// </summary>
