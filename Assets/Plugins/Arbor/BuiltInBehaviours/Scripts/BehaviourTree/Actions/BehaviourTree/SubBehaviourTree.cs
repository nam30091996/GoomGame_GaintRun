...
namespace Arbor.BehaviourTree.Actions
{
	...
	/// <param name="Execution Settings" order="10">実行に関する設定。</param>
#else
	/// <summary>
	/// Play a child hierarchy Behavior Tree
	/// </summary>
	/// <param name="OpenButton" order="-1">Open Behavior Tree of child hierarchy</param>
	// <param name="Execution Settings" order="10">Settings related to execution.</param>
#endif
	[AddComponentMenu("")]
	...
	[ExcludeFromPreset]
#endif
	public sealed class SubBehaviourTree : ActionBehaviour, INodeGraphContainer
	{
		[SerializeField]
		[HideInInspector]
