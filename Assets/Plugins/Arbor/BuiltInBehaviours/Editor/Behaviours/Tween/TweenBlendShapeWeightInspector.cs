...
namespace ArborEditor.StateMachine.StateBehaviours
{
	...
	internal sealed class TweenBlendShapeWeightInspector : TweenBaseInspector
	{
		...
		BlendShapePropertyEditor GetPropertyEditor(int index)
		{
			...
			var fieldInfo = EditorGUITools.GetFieldInfoFromProperty(blendShapeProperty, out fieldType);
			BlendShapePropertyEditor propertyEditor = PropertyEditorUtility.GetPropertyEditor<BlendShapePropertyEditor>(blendShapeProperty, fieldInfo);
