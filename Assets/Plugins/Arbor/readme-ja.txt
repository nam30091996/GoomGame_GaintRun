...
* Assets/Plugins/Arbor/CHANGELOG-ja
  更新ログ
* Assets/Plugins/Arbor/Docs/ArborManual_ja.zip
  Arborの取扱説明書。
  閲覧する際は任意のフォルダに解凍してください。
* Assets/Plugins/Arbor/Docs/ArborReference_ja.zip
  Arborで使用できるコンポーネントや、ノード用の組み込みスクリプトのリファレンス。
  閲覧する際は任意のフォルダに解凍してください。
* Assets/Plugins/Arbor/Docs/ScriptReference_ja.zip
  スクリプトリファレンス。
  スクリプトからArborのAPIを呼び出す際に参照してください。
  閲覧する際は任意のフォルダに解凍してください。
...
* マニュアル : https://caitsithware.com/assets/arbor/docs/ja/index.html
  詳しい使用方法のマニュアル。
  同梱しているArborManual_ja.zipと同様のもの。
* Arborリファレンス : https://arbor-docs.caitsithware.com/ja/
  Arborで使用できるコンポーネントや、ノード用の組み込みスクリプトのリファレンス。
  同梱しているArborReference_ja.zipと同様のもの。
* スクリプトリファレンス : https://caitsithware.com/assets/arbor/scriptreference/ja/annotated.html
  Arborで使用できるクラスなどのリファレンス。
  同梱しているScriptReference_ja.zipと同様のもの。

### オンラインドキュメントのダウンロード

https://arbor.caitsithware.com/download_reference/

こちらから各種オンラインドキュメントをダウンロードできます。
